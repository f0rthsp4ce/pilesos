...
class RightWheelController(WheelController):
    EN = 26
    PHASE = 16


class LeftWheelController(WheelController):
    EN = 5
    PHASE = 13
    reversed = True


left_wheel_controller = LeftWheelController()
right_wheel_controller = RightWheelController()
